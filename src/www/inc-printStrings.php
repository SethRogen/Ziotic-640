<?php
	...
	function printStrings($lang = "en") {
		$file = "./xml/lang/" .$lang. ".xml";
		$xml = simplexml_load_file($file);
		$count = array("xml" => count($xml->item));
...
<table border="0" cellpadding="3" width="600">';
		...
		for($a = 0; $a < $count['xml']; $a++) {
			...
			//echo "<b>id:</b> " .$a. "<br />";
			echo '<tr><td class="e">' .strtoupper($xml->item[$a]->name). ' </td><td class="v">' .$xml->item[$a]->string. " </td></tr>";
		}
